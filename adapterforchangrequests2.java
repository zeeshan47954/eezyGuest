...
public class adapterforchangrequests2 extends RecyclerView.Adapter<adapterforchangrequests2.ViewHolder> {
    interface Listener1 {
...
Listener2 listener2;
    ...
    public adapterforchangrequests2(List captions) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewtype) {
        CardView cv = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_for_owner11part11, parent, false);
