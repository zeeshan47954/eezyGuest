...
import com.example.bookandpostroom.MainActivity;
import com.example.bookandpostroom.R;
import com.example.bookandpostroom.SystemBarsUtil;
    ...
    public void deleteData(android.view.View view) {
        ...
        ds.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.child("actualrequestsrecieved").hasChildren())
                {
                    dd.dismiss();

                    Snackbar.make(findViewById(android.R.id.content),
                            "deletion not possible rightnow,either wait for expiration of pending requests or remove current tenants",
                            Snackbar.LENGTH_LONG).show();
                }
                if(snapshot.child("rooms").hasChildren())
                {
                    dd.dismiss();
                    Toast.makeText(settingsadmin.this, "please delete your rooms first", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    new AlertDialog.Builder(settingsadmin.this)
                            ...
                            .setPositiveButton(ok, (dialog, which) -> {
                                ...
                                ds.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {

                                        Toast.makeText(settingsadmin.this, "Deleted all the info", Toast.LENGTH_SHORT).show();
                                        Intent i=new Intent(settingsadmin.this,MainActivity.class);
                                        startActivity(i);
                                    }
                                });
