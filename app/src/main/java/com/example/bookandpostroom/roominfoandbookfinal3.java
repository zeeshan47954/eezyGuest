...
public class roominfoandbookfinal3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roominfoandbookfinal3);
...
tv1=findViewById(R.id.textView1);
        ...
        gh.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                tv1.setText("room type: " + roomtype + "\n" + "\n" + "room location: " + roomlocation + "\n" + "district: " + district + "\n" + "room capacity: " + capacity);
                    ...
                    Toast.makeText(roominfoandbookfinal3.this, "data doesnt exist", Toast.LENGTH_SHORT).show();
                    finish();
        ...
        dkk.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                if (listResult.getItems().isEmpty()) {
                    Toast.makeText(roominfoandbookfinal3.this, "No images found", Toast.LENGTH_SHORT).show();
                    Toast.makeText(roominfoandbookfinal3.this, "No images found", Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(roominfoandbookfinal3.this, "Sorry, an error occurred while fetching the images", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void onAllUrisFetched(){
        ...
        ImageAdapter adapter = new ImageAdapter(this, imagesfinal);
            ...
            dotsIndicator.setSelectedTabIndicatorColor(ContextCompat.getColor(roominfoandbookfinal3.this, R.color.teal));
                    ...
                    for (int k = 0; k < dotsIndicator.getTabCount(); k++) {
                        ...
                        if (tab != null) {
                            tab.view.setBackgroundTintList(k == position
                                    ? ColorStateList.valueOf(ContextCompat.getColor(roominfoandbookfinal3.this, R.color.teal))
                                    : ColorStateList.valueOf(ContextCompat.getColor(roominfoandbookfinal3.this, R.color.white)));
                        }
                    }
                }
            });
